...
embeddings = np.load("shopee-product-matching/siamese_projected_embeddings.npy")
output_submission_path = "v1_Siamese.csv"
...
threshold = similarities.mean() + similarities.std() * 1.3
